    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <Link className="flex items-center justify-center" href="#">
          ...
          <span
            className={`ml-2 text-2xl font-bold text-gray-900 ${playfairDisplaySc.className}`}
          >
            CargoNavis
          </span>
        </Link>
      ...
      <main className="flex-1">
        <section
          ...
          style={{
            background: 'linear-gradient(45deg,#13949f,35%,transparent)',
          }}
        >
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2 max-w-[760px]">
                ...
                >
                  Navigate Your Logistics with{' '}
                  <span className={playfairDisplaySc.className}>
                    CargoNavis
                  </span>
                </h1>
                <p className="mx-auto max-w-[700px] text-gray-700 md:text-xl dark:text-gray-400">
                  Effortlessly manage your trucks, employees, and shipments all
                  in one powerful platform.
                </p>
              </div>
              <div className="space-x-4">
                <Button className="bg-[#0E6A75] text-white hover:bg-[#0E6A75]/90">
                  Get Started
                </Button>
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-500">
                  Efficiently track and manage your entire fleet of trucks in
                  real-time.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-500">
                  Easily create and manage employee schedules to optimize
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-500">
                  Monitor your shipments from pickup to delivery with detailed
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-500">
                  Ensure your operations meet industry standards with our
                  security features.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Ready to Navigate Your Logistics?
                </h2>
                <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Join thousands of companies already using CargoNavis to
              ...
              <div className="w-full max-w-sm space-y-2">
                <form className="flex space-x-2">
                  ...
                  />
                  <Button
                    className="bg-[#0E6A75] text-white hover:bg-[#0E6A75]/90"
                    type="submit"
                  >
                    Get Started
                  </Button>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          © 2024 CargoNavis. All rights reserved.
        </p>
